...
class CuentaBancaria():
    ...
    def depositar(self, monto_depositado:int):
        ...
        return print(f"El saldo actual es de {self._saldo}")
    ...
    def mostrar_datos(self):
        return print(f"Titular: {self.titular}. Saldo: {self._saldo}. CBU: {self.cbu}. ULTIMAS TRANSACCIONES: {self._transacciones}.")
...
class Estudiantes():
    ...
    def mostrar_datos(self):
        return print(f"Nombre: {self.nombre}, edad: {self.edad} y calificaciones: {self.calificaciones}")
...
class Coche():
    ...
    def acelerar(self, nueva_velocidad):
        ...
        return print(f"La velocidad actual es de {self._velocidad}.")
    
    def cargarNafta(self, nafta_cargada):
        self._cant_nafta = self._cant_nafta + nafta_cargada
        return print(f"La nafta actual es de: {self._cant_nafta}")
...
coche.cargarNafta(25)

coche.datosKilometraje()
